...
public class MatteGlassView extends View {
    ...
    public MatteGlassView(Context context, AttributeSet attrs) {
        ...
        mBlurRadius = a.getDimension(R.styleable.MatteGlassView_matteRadius,
                TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 10, context.getResources().getDisplayMetrics()));
        mDownsampleFactor = a.getFloat(R.styleable.MatteGlassView_matteDownSample, 4);
        mOverlayColor = a.getColor(R.styleable.MatteGlassView_matteLayColor, 0xAAFFFFFF);
        a.recycle();
    ...
    static {
        try {
            MatteGlassView.class.getClassLoader().loadClass("android.support.v8.renderscript.RenderScript");
